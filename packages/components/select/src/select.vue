...
const emit = defineEmits(['update:modelValue', 'update:label', 'fetch', 'change'])
...
props.defaultValue && emit('update:modelValue', props.defaultValue)
